		...
		void OnGUI ()
		{
				if (_listOfPanels.Length > 0) {
						if (_activePanelIndex <= 0) {
								_TransitionLeftButton.renderer.enabled = false;
								_TransitionLeftButton.collider2D.enabled = false;
						} else {
								_TransitionLeftButton.renderer.enabled = true;
								_TransitionLeftButton.collider2D.enabled = true;
						}
						if (_activePanelIndex >= _listOfPanels.Length - 1) {
								_TransitionRightButton.renderer.enabled = false;
								_TransitionRightButton.collider2D.enabled = false;
						} else {
								_TransitionRightButton.renderer.enabled = true;
								_TransitionRightButton.collider2D.enabled = true;
						}
				} 
		}
